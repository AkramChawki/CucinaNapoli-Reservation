                    ...
                    <div className="mx-auto max-w-7xl w-full pt-16 pb-20 text-center lg:py-0 lg:h-screen lg:flex lg:items-center lg:text-left">
                        <div className="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
                            ...
                            <p className="mt-3 max-w-md mx-auto text-lg text-gray-500 sm:text-xl md:mt-5 md:max-w-3xl">
                                LA VERRA PIZZA NAPOLETANA !!
                            </p>
                            <div className="mt-10 sm:flex sm:justify-center lg:justify-start">
                                <div className="rounded-md shadow">
                                    <a
                                        href="#restaurants"
                                        className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-green-700 hover:opacity-90 md:py-4 md:text-lg md:px-10"
                                    >
                                        Reservez
                                    </a>
                                </div>
            ...
            >
                <div className="relative flex">
                    ...
                    <div className="relative w-full flex flex-col items-center justify-center bg-black bg-opacity-40 text-center py-20">
                        ...
                        <Link
                            href="/reservation" method="get" data={{ restaurant: 1 }}
                ...
                <div className="relative flex">
                    ...
                    <div className="relative w-full flex flex-col items-center justify-center bg-black bg-opacity-40 text-center py-20">
                        ...
                        <a href="https://www.google.com/maps/place/CUCINA+NAPOLI+-+Palmier+-+Restaurant+italien/@33.5792518,-7.6266445,15z/data=!4m2!3m1!1s0x0:0x4a188f323bca5ea6?sa=X&ved=2ahUKEwil3oiSuaf_AhXwTaQEHU_YDm4Q_BJ6BAhgEAk" className="my-2 text-5xl font-bold text-white">
                            Cucina Napoli - Plamier
                        </a>
                        <Link
                            href="/reservation" method="get" data={{ restaurant: 2 }}
                            className="mt-4 font-medium text-gray-900 bg-white py-2.5 px-4 rounded-md hover:bg-gray-50"
                        >
                            reserver
                        </Link>
